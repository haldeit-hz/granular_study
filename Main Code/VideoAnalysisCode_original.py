...
def analyze_movies(video_path, output_folder, xx, yy, ww, hh, in_range1, in_range2, in_range3, in_range4a, in_range4b, walls):
    ...
    while True:
        ...
        #----------------------------------------
        binary1 = cv.bitwise_or(binary1, binary2)
        ...
        cv.imwrite(f"{output_folder}BinaryImages/AllPartsBinaryFrame_{curr_frame:01d}.png", binary1)
...
analyze_movies("./movies/yellow.mov", "./results_yellow-1/", 335, 25, 1265, 940, in_range1=white_range,in_range2=yellow_range, in_range3=green_range, in_range4a=red_range1, in_range4b = red_range2, walls=None )
